package com.megha.consumer.configuration;
...
import com.megha.fuel.consumer.component.ConsumerFuelService;

@SuppressWarnings("unused")
@Configuration
public class RabbitMqConfigConsumer implements RabbitListenerConfigurer {
	...
	@Autowired
	private ConsumerFuelService consumerFuelService;
}
